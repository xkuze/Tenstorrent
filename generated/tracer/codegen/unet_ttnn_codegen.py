...
def top_level_module():
    variable_0 = torch.randn(
        1, 3, 256, 256
    )  # shapes: (1, 3, 256, 256), dtypes: torch.float32; duration: 1.4 ms
    variable_1 = (
        torch.as_tensor(
            [
                -0.6618398427963257,
    ...
    )  # shapes: (1, 1, 256, 256), dtypes: torch.float32; duration: 277.5 ms
