...
def objective(trial: optuna.Trial):
    ...
    print(f"  Trial {trial.number}: filters={num_filters}, kernel={kernel_size}, dropout={dropout:.2f}, lr={lr:.6f}, opt={optimizer} -> val_acc={val_acc*100:.2f}%")
...
def run_hyperparameter_search():
    ...
    print(f"\n{'='*60}")
    print(f"Optuna Hyperparameter Search - CIFAR-10 CNN")
    print(f"{'='*60}")
